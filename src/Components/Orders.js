...
import ShowReceiptsAsList from "./ShowReceiptsAsList";
...
function Orders() {
    ...
    const todays="Todays Orders";
    const yesterdays="Yesterdays Orders";
    ...
    return (
        <>
            <MainNavbar/>
            <ShowReceiptsAsList
                todaysOrYesterdaysReceipts={todays}
                todaysOrYesterdaysDate={todaysDate}
                todaysOrYesterdaysOrders={todaysOrders}
            />
            <ShowReceiptsAsList
                todaysOrYesterdaysReceipts={yesterdays}
                todaysOrYesterdaysDate={yesterdaysDate}
                todaysOrYesterdaysOrders={yesterdaysOrders}
            />
